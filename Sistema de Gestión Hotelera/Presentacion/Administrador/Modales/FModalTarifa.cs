...
namespace Presentacion.Administrador.Modales
{
    internal class FModalTarifa : FormModalBase
    {
        ...
        public FModalTarifa(Tarifa? tarifa)
        {
            ...
            Contenido.Controls.Add(CamposFormulario.Etiqueta("Precio por hora ($)", new Point(0, y)));
            _numHora = CamposFormulario.Numerico(new Point(0, y + 22), ancho, 0, 9_999_999, 2);
            Contenido.Controls.Add(_numHora);
            y += 62;

            Contenido.Controls.Add(CamposFormulario.Etiqueta("Precio por fracción ($)", new Point(0, y)));
            _numFraccion = CamposFormulario.Numerico(new Point(0, y + 22), ancho, 0, 9_999_999, 2);
            Contenido.Controls.Add(_numFraccion);
            y += 62;
        ...
        private void CargarDatosIniciales()
        {
            ...
            _numFraccion.Value = _tarifaOriginal.PrecioPorFraccion;
        ...
        private void Guardar()
        {
            ...
            var tarifa = new Tarifa
            {
                ...
                PrecioPorFraccion = _numFraccion.Value,
