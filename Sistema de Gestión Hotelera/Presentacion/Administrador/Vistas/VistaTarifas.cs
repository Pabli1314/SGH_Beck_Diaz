...
namespace Presentacion.Administrador.Vistas
{
    internal class VistaTarifas : UserControl, IVistaAdministrador
    {
        ...
        private void ConfigurarColumnas()
        {
            ...
            _dgv.Columns.Add(new DataGridViewTextBoxColumn { Name = "Hora", HeaderText = "Precio por hora", Width = 150, DefaultCellStyle = { Alignment = DataGridViewContentAlignment.MiddleRight } });
            _dgv.Columns.Add(new DataGridViewTextBoxColumn { Name = "Fraccion", HeaderText = "Precio por fracción", Width = 160, DefaultCellStyle = { Alignment = DataGridViewContentAlignment.MiddleRight } });
        ...
        private void CargarDatos()
        {
            ...
            foreach (Tarifa tarifa in _tarifas)
            {
                int fila = _dgv.Rows.Add(
                    ...
                    tarifa.PrecioPorFraccion.ToString("C0"),
